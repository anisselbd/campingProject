...
export function Footer() {
    return (
        <Box style={{ backgroundColor: '#2b2b2b', color: 'white', marginTop: rem(80), padding: `${rem(60)} 0` }}>
            <Container size="xl">
                <SimpleGrid cols={{ base: 1, sm: 2, md: 4 }} spacing={50}>
                    ...
                    <Stack gap="xs">
                        ...
                        <Text size="sm" c="dimmed" style={{ cursor: 'pointer' }}>Pourquoi nous choisir ?</Text>
                    ...
                    <Stack gap="xs">
                        ...
                        <Text size="sm" c="dimmed" style={{ cursor: 'pointer' }}>Contactez-nous</Text>
                    </Stack>
                    ...
                    <Stack gap="lg">
                        ...
                        <Group gap={0}>
                            ...
                            />
                            <Button variant="white" color="dark" size="md" radius="md" style={{ borderRadius: '0 8px 8px 0', border: 'none' }}>
                                S'abonner
                            </Button>
                        </Group>
                    </Stack>
                ...
                <Group justify="center" mt={60} style={{ position: 'relative' }}>
